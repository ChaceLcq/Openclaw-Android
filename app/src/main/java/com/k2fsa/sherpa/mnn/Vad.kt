...
data class SileroVadModelConfig(
    ...
    var minSilenceDuration: Float = 0.8F,  // 增加最小静音持续时间为0.8秒，配合没有尾部填充的设置
    var minSpeechDuration: Float = 0.5F,   // 增加最小语音持续时间为0.5秒
    var windowSize: Int = 512,
    var maxSpeechDuration: Float = 15.0F,  // 增加最大语音持续时间为15.0秒，配合没有尾部填充的设置
)
